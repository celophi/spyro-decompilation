...
static func decompiledFunction = (func) &DrawDemoText;

/// @brief Address of the original function to invoke.
extern int OG_DrawDemoText;
static func originalFunction = (func) &OG_DrawDemoText;
...
static void Tester()
{
    ...
    // Record results.
    printf("DrawDemoText Test Result: %d/%d\n", hits, total);
    
    LeaveCriticalSection();
}

/// @brief Hook installation entry point.
void InstallDrawDemoTextTest()
{
