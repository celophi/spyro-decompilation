...

{
    ...
    uint uVar7;
    int uVar9;
    SkyboxModel **wadModelEnd;
    uint uVar8;
    SkyboxModel **modelsToRender;
    int *cursor;
    int unaff_s0;
    uint uVar10;
    int unaff_s1;
    ...
    //_RegisterStorage.GP = (int)&_StaticDataStart;
    ...
    modelsToRender = &_SkyboxModelsToRender;
    wadModelEnd = _SkyboxWadModels + _SkyboxWadModelCount;
    wadModelStart = _SkyboxWadModels;
    /*
    _RegisterStorage.S0 = unaff_s0;
    _RegisterStorage.S1 = unaff_s1;
    _RegisterStorage.S2 = unaff_s2;
    _RegisterStorage.S3 = unaff_s3;
    _RegisterStorage.S4 = unaff_s4;
    _RegisterStorage.S5 = unaff_s5;
    _RegisterStorage.S6 = unaff_s6;
    _RegisterStorage.S7 = unaff_s7;
    _RegisterStorage.SP = (int)register0x00000074;
    _RegisterStorage.FP = unaff_s8;
    _RegisterStorage.RA = unaff_retaddr;*/
...
DrawFadeInSkybox_A:
                ...
                if ((P_TAG *)pDVar23 != pPVar19) {
                    ...
                    *pDVar19 = uVar18 ^ 0x80000000;
                    ...
                    if (pPVar4 == (P_TAG *)0x0) {
                        ...
                        //*(short *)pPVar4 = (short)pPVar19;
                        //pPVar4->field_0x2 = (char)((uint)pPVar19 >> 0x10);
        ...
        while( true ) {
            uVar10 = *puVar11;
            puVar15 = puVar11 + 2;
            if (puVar11 == puVar14 + (uVar8 & 0x1fff) * 2) break;
