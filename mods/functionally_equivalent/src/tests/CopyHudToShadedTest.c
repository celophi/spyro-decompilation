...
static func decompiledFunction = (func) &CopyHudToShaded;

/// @brief Address of the original function to invoke.
extern int OG_CopyHudToShaded;
static func originalFunction = (func) &OG_CopyHudToShaded;
...
static void Tester()
{
    ...
    // Record results.
    printf("CopyHudToShaded Test Result: %d/%d\n", hits, total);
    
    LeaveCriticalSection();
}

/// @brief Hook installation entry point.
void InstallCopyHudToShadedTest()
{
